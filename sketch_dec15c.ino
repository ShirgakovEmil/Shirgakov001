...
String balance = "*100#";               //номер для проверки баланса Sim карты GSM сигнализации
void numbr_sms(){
  SIM800.println("AT+CMGS=\"+79221236906\"");   //1 номер для получения СМС, вписывается в международном формате начиная с +
  delay(3000);
}
...
if (stat_a1 == HIGH) {str_a1 = "A1 is OPEN!";}
...
if (stat_a3 == HIGH && signalingS == signaling_OK) { str_a3 = "A3 OK!";}
if (stat_a3 == LOW) {str_a3 = "A3 WORKED!";}

 stat_a4 = digitalRead(a4);
if (stat_a4 == HIGH && signalingS == signaling_OK) { str_a4 = "A4 OK!";}
if (stat_a4 == LOW) {str_a4 = "A4 WORKED!";}

 stat_a5 = digitalRead(a5);
if (stat_a5 == HIGH && signalingS == signaling_OK) { str_a5 = "A5 OK!";}
if (stat_a5 == LOW) {str_a5 = "A5 WORKED!";}
...
//опрос датчиков
if(stat_a1 == LOW && stat_a2 == LOW && stat_a3 == HIGH && stat_a4 == HIGH && stat_a5 == HIGH)
...
//опрос датчиков
if(stat_a1 == HIGH || stat_a2 == HIGH || stat_a3 == LOW || stat_a4 == LOW || stat_a5 == LOW)
